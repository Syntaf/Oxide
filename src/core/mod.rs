...
// so hide them all
#[doc(hidden)]
pub use core::painter::Painter;
#[doc(hidden)]
pub use core::alignable::Alignable;
#[doc(hidden)]
...
#[doc(hidden)]
pub use core::button::{Button, find_accel_char_index};
#[doc(hidden)]
pub use core::attributes::{ButtonResult, HorizontalAlign, VerticalAlign};
